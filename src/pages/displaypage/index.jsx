	...
	<div class="max-w-5xl mx-auto px-5 mb-3">
		<div class="mt-4 grid grid-cols-1  gap-x-6  lg:grid-cols-3 xl:gap-x-8">
			<div
				...
				class="max-w-xl bg-white rounded-lg border border-gray-200 shadow-md White:bg-gray-800 white:border-gray-700">
				<a href="#">
                    <center>
                    <h1>Package name</h1>
                        <br></br>
                <img src="https://mdbootstrap.com//img/Photos/Square/1.jpg" class="max-w-full h-48 rounded-full" alt="step3"/>
                </center>
    </a>
					<div class="p-5">
						<a href="#">
...
<div className="card2">
<div class='flex items-center justify-left min-h-screen'>  <div class="rounded-xl border p-5 shadow-md w-9/12 bg-white">

...
const Userprofile = () => {
	return (
		<div>
			...
			<div class="usercard">
				<div>
					<div class=" flex flex-col bg-white justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12  white:text-dark">
						<img
							src="https://source.unsplash.com/150x150/?portrait?3"
							alt=""
							class="w-32 h-32 mx-auto rounded-full aspect-square"
						/>
						<div class="space-y-4 text-center divide-y divide-white-700">
					...
					<div class="w-full max-w-2xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
						...
						<div class="p-3">
							<div class="overflow-x-auto">
								<table class="table-auto max-w-96">
